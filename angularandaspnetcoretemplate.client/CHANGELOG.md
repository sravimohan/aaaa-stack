...
- Create Angular project with ng: `ng new angularandaspnetcoretemplate.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`angularandaspnetcoretemplate.client.esproj`).
